...
class Train:
    ...
    def begin_cloud(self):
        ...
        cloud_instance = CloudClass(settings=self.settings, instance_ids=self.instance_ids, project_name=self.project_name, dataset_class=dataset_class, dev=self.dev)
